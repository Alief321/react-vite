      ...
      <div className="container px-4 py-12 md:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Building amazing products for the modern web. Empowering developers and businesses worldwide.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#cookies" className="text-muted-foreground transition-colors hover:text-foreground">
                  Cookie Policy
                </a>
              </li>
              <li>
                <a href="#license" className="text-muted-foreground transition-colors hover:text-foreground">
                  License
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-8 md:flex-row">
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Logo. All rights reserved.</p>
